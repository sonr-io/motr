...
<Tabs>
  <Tab title="Browser Auto-Detection">
    ```typescript
    import { createMotorPlugin } from '@sonr.io/sdk/client/motor';
  ...
  <Tab title="Browser Service Worker">
    ```typescript
    import { createMotorPluginForBrowser } from '@sonr.io/sdk/client/motor';
  ...
  <Tab title="Node.js">
    ```typescript
    import { createMotorPluginForNode } from '@sonr.io/sdk/client/motor';
