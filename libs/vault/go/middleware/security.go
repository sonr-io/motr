...
func applySecurityHeaders(w http.ResponseWriter) {
	// CORS headers (already handled by utils.HandleCORS, but adding for completeness)
...
// utils.WriteJSON writes JSON response
func utils.WriteJSON(w http.ResponseWriter, status int, data interface{}) {
...
// utils.WriteError writes error response
func utils.WriteError(w http.ResponseWriter, status int, message string) {
