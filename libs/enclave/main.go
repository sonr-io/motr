...
// GetEnclaveConfig loads vault configuration from PDK environment
func GetEnclaveConfig() map[string]any {
...
// NewOriginTokenRequest is the request body for creating a new origin token
