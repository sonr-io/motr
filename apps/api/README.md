...
Motr Orchestrator Worker - Central Cloudflare Worker serving multiple frontend apps with session management and smart routing.
...
- All frontend assets are aggregated into `x/worker/public/` during build
...
│   ├── auth/                        # Auth app assets
│   ├── console/                     # Console app assets
│   ├── profile/                     # Profile app assets
│   ├── search/                      # Search app assets
...
This script:
1. Cleans the `x/worker/public/` directory
2. Copies all built frontend app assets from `apps/*/dist` to `public/{app}/`
