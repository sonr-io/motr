...
export function BalanceInfo() {
  ...
  const error = null;
  const data = submittedAddress ? [{ denom: 'usnr', amount: '1000' }] : null;
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Query native token balances (auto-refreshes every 30s)</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {data != null && (
          <div className="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
            <p className="text-sm font-medium text-blue-900 dark:text-blue-100 mb-2">Balances</p>
