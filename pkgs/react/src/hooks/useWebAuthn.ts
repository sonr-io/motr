...
export function useWebAuthn() {
  ...
  const register = useCallback(async (options: WebAuthnRegistrationOptions): Promise<WebAuthnCredential> => {
    setIsLoading(true);
    setError(null);
  ...
  const authenticate = useCallback(async (options?: WebAuthnAuthenticationOptions): Promise<WebAuthnCredential> => {
    setIsLoading(true);
    setError(null);
