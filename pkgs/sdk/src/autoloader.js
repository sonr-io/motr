/**
 * @sonr.io/sdk - ESM Autoloader for Browser
 *
 * This file automatically loads and exposes all Sonr ES modules
 * for browser usage via script tag or dynamic import.
 *
 * Usage:
 * <script type="module" src="https://unpkg.com/@sonr.io/sdk/dist/autoloader.js"></script>
 *
...
if (typeof window !== "undefined") {
  ...
  // Log availability
  console.log(
    "[Sonr] Library loaded. Access via window.Sonr or import modules directly.",
  );
