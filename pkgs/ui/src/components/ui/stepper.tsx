...
function StepperList(props: StepperListProps) {
  ...
  const onFocus = React.useCallback(
    ...
    [listProps.onFocus, isTabbingBackOut, currentValue, tabStopId, listProps]
  );
...
function StepperTrigger(props: ButtonProps) {
  ...
  const onMouseDown = React.useCallback(
    ...
    [focusContext, triggerId, isDisabled, triggerProps.onMouseDown, triggerProps]
  );
...
function StepperPrevTrigger(props: ButtonProps) {
  ...
  const onClick = React.useCallback(
    ...
    [prevTriggerProps.onClick, isDisabled, currentIndex, stepKeys, store, prevTriggerProps]
  );
...
function StepperNextTrigger(props: ButtonProps) {
  ...
  const onClick = React.useCallback(
    ...
    [nextTriggerProps.onClick, isDisabled, currentIndex, stepKeys, store, nextTriggerProps]
  );
