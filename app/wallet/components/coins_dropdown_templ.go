...
import "github.com/sonr-io/motr/app/wallet/types"
...
func CoinOption(a types.CoinInfo) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if a.IsDefault {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/wallet/components/coins_dropdown.templ`, Line: 51, Col: 29}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/wallet/components/coins_dropdown.templ`, Line: 52, Col: 41}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/wallet/components/coins_dropdown.templ`, Line: 53, Col: 11}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/wallet/components/coins_dropdown.templ`, Line: 57, Col: 29}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/wallet/components/coins_dropdown.templ`, Line: 58, Col: 41}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/wallet/components/coins_dropdown.templ`, Line: 59, Col: 11}
			}
